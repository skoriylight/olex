...
class m171017_051933_cretare_order_tables extends Migration
{
    public function safeUp()
    {
        ...
        try {
            $this->createTable('{{%order}}', [
                ...
                'client_phone' => Schema::TYPE_STRING . "(20)",
                'email' => Schema::TYPE_STRING . "(100) NOT NULL",
                'client_city' => Schema::TYPE_STRING . "(255) NOT NULL",
                'promocode' => Schema::TYPE_STRING . "(100)",

                'reciver_name' => Schema::TYPE_STRING . "(255) NOT NULL",
                'reciver_phone' => Schema::TYPE_STRING . "(20)",
                'reciver_city' => Schema::TYPE_STRING . "(255) NOT NULL",
