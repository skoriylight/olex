...
class User extends \app\modules\user\models\User
{
    ...
    public function scenarios()
    {
        ...
        $scenarios[self::SCENARIO_ADMIN_CREATE] = ['username', 'email', 'status', 'role', 'newPassword', 'price_type', 'newPasswordRepeat'];
        $scenarios[self::SCENARIO_ADMIN_UPDATE] = ['username', 'email', 'status', 'role', 'newPassword', 'price_type','newPasswordRepeat'];
        return $scenarios;
    }
